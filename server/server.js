...
const gameLogic = require('./gamelogic/logic')
const chatLogic = require('./chatlogic/chat')
...
const io = socketio(server, {
    cors: {
        credentials: true,
        origin: 'https://wechess.onrender.com'
    }
})
...
io.on('connection', client => {
    ...
    chatLogic.initializeChat(io, client)
})


// usually this is where we try to connect to our DB.
server.listen(process.env.PORT || 8000, () => console.log(`Server listen on port 8000`))